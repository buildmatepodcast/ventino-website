...
export const woodFinishes: Finish[] = [
  { name: "Western Red Cedar",  hex: "#8B3A2A", image: "/finishes/wood/western-red-cedar.png",  range: "powder-wood" },
  ...
  { name: "Dark Beige",         hex: "#C8A870", image: "/finishes/wood/dark-beige.png",          range: "powder-wood" },
  ...
  { name: "Snow Drift",         hex: "#E8E0D0", image: "/finishes/wood/snow-drift.png",          range: "powder-wood" },
  ...
  { name: "Grey V2",            hex: "#8C8880", image: "/finishes/wood/grey-v2.png",             range: "powder-wood" },
